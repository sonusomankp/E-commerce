				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="${pageContext.request.contextPath}/resources/proimages/${sup.img}" /></div>
						 
						</div>
						<ul class="preview-thumbnail nav nav-tabs">
						  <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="${pageContext.request.contextPath}/resources/proimages/${sup.img}" /></a></li>
						  
						</ul>
						
					</div>
					<div class="details col-md-6">
						<h3 class="product-title"> ${sup.name}</h3>
						<div class="rating">
							<div class="stars">
					...
					<a href="buy"><button class="buynw btn btn-default" type="button">Buy now</button></a>
						</c:if>	
